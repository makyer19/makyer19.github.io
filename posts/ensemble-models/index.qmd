...
Now we can combine these two types of models. By putting together a multiude of decision trees models, we can make an ensemble model of decision trees. If this sounds familiar, that is because this specific combination falls under the aforementioned random forest model. For our example, we will use a classification through a random forest decision tree/ensemble model.
